...
public class DialogAddKH3 extends JDialog {
...
//	public panelBanHang banHang;
	...
	public DialogAddKH3(PanelKhXacNhanDatSach datSach) {
		new DialogAddKH();
...
//        this.banHang.onDataReturned(txtMaKH.getText());
          this.datSach.onDataReturnedKH(txtMaKH.getText(),model.getValueAt(i,4).toString());
