...
public class DialogAddSP4 extends JDialog {
...
//	public PanelKhXacNhanDatSach datSach;
	...
	public DialogAddSP4(DialogFixKm dialogFix) {
		new DialogAddSP();
...
//		});
	...
	public DialogFixKm getDialogFix() {
		return dialogFix;
	}

	public void setDialogFix(DialogFixKm dialogFix) {
		this.dialogFix = dialogFix;
	}
...
//					row[9] = 
	 ...
	 private void onSubmitButtonClick() {
	        ...
	        this.dialogFix.onDataReturnedSP(txtMaSP.getText());
//	        this.datSach.soLuongSPTemp = soLuongReturn;
//	        this.datSach.tenSach = tenSach;
//	        this.datSach.giaBan = giaBan;
//	        this.datSach.discount = di
//	        System.out.println();
