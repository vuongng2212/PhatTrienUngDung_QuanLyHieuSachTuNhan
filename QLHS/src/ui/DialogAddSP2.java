...
public class DialogAddSP2 extends JDialog {
	...
	public DialogAddSP2(PanelKHDatSach datSach) {
		new DialogAddSP();
...
//		});
	...
	public PanelKHDatSach getDatSach() {
		return datSach;
	}

	public void setDatSach(PanelKHDatSach datSach) {
		this.datSach = datSach;
	}
...
//					row[9] = 
	 ...
	 private void onSubmitButtonClick() {
	        ...
	        this.datSach.onDataReturnedSP(txtMaSP.getText());
